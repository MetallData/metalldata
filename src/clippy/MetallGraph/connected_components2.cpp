...
static const std::string method_name = "connected_components2";
...
int main(int argc, char **argv) try {
  ...
  clippy::clippy clip{method_name,
                      "v2 Computes the connected components of a graph"};
  ...
  auto rc = mg.connected_components2(sname, where_c);
