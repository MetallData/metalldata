...
const std::string ARG_VERTEX_FILES_DESC = "A list of Json files that will be imported as vertices.";
} // anonymous
...
int ygm_main(ygm::comm& world, int argc, char** argv)
{
  ...
  clip.add_required<ARG_VERTEX_FILES_TYPE>(ARG_VERTEX_FILES_NAME, ARG_VERTEX_FILES_DESC);
