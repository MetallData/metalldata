...
const std::string          ARG_AUTO_VERTEX_DESC = "two field names from which the vertices are generated";
const ARG_AUTO_VERTEX_TYPE ARG_AUTO_VERTEX_DFLT = {};

//~ using                              ARG_AUTO_SRC_VERTEX_TYPE = boost::json::object;
//~ const std::string                  ARG_AUTO_SRC_VERTEX_NAME = "autoSourceVertex";
//~ const std::string                  ARG_AUTO_SRC_VERTEX_DESC = "a JSON logic expression, describing how to compute the source vertex";
//~ const ARG_AUTO_SRC_VERTEX_KEY_TYPE ARG_AUTO_SRC_VERTEX_DFLT = {};

//~ using                              ARG_AUTO_SRC_VERTEX_TYPE = boost::json::object;
//~ const std::string                  ARG_AUTO_SRC_VERTEX_NAME = "autoTargetVertex";
//~ const std::string                  ARG_AUTO_SRC_VERTEX_DESC = "a JSON logic expression, describing how to compute the target vertex";
//~ const ARG_AUTO_SRC_VERTEX_KEY_TYPE ARG_AUTO_SRC_VERTEX_DFLT = {};
...
int ygm_main(ygm::comm& world, int argc, char** argv)
{
  ...
  clip.add_optional<ARG_AUTO_VERTEX_TYPE>(ARG_AUTO_VERTEX_NAME, ARG_AUTO_VERTEX_DESC, ARG_AUTO_VERTEX_DFLT);
  //~ clip.add_optional<ARG_AUTO_SRC_VERTEX_TYPE>(ARG_AUTO_SRC_VERTEX_NAME, ARG_AUTO_SRC_VERTEX_DESC, ARG_AUTO_SRC_VERTEX_DFLT);
  //~ clip.add_optional<ARG_AUTO_TGT_VERTEX_TYPE>(ARG_AUTO_TGT_VERTEX_NAME, ARG_AUTO_TGT_VERTEX_DESC, ARG_AUTO_TGT_VERTEX_DFLT);
