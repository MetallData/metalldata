...
const std::string ARG_NODES_FILES_DESC =
    "A list of Json files that will be imported as nodes.";

const std::string ARG_EDGES_FILES_NAME = "edge_files";
const std::string ARG_EDGES_FILES_DESC =
...
int ygm_main(ygm::comm& world, int argc, char** argv) {
  ...
  clip.add_optional<std::vector<std::string> >(ARG_NODES_FILES_NAME,
                                               ARG_NODES_FILES_DESC, {});
  clip.add_optional<std::vector<std::string> >(ARG_EDGES_FILES_NAME,
                                               ARG_EDGES_FILES_DESC, {});
  ...
  try {
    ...
    const std::vector<std::string> nodeFiles =
        clip.get<std::vector<std::string> >(ARG_NODES_FILES_NAME);
    const std::vector<std::string> edgeFiles =
        clip.get<std::vector<std::string> >(ARG_EDGES_FILES_NAME);
